...
#unordered list of unique drugs
...
drug_cleaning={'Bupropion':'Bupropr{0,1}io','Fluoxetine':'FLUOXEn?TIN','Sertraline':'SERTRALIN',
                'Paroxetine':'PARa?OX[aei]T','Fluv[io]xamine':'fluvoxamin','Citalopram':'CITALOPRA',
               'Escitalopram':'escitalopra','Trazadone':'Traz[ae]d'}
print('.',end='')
